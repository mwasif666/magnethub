...
import location_1 from "@/assets/img/category/cars.jpg";
import location_2 from "@/assets/img/category/book.jpg";
import location_3 from "@/assets/img/category/bikes.jpg";
import location_4 from "@/assets/img/category/coffee.jpg";
import location_5 from "@/assets/img/category/rent.jpg";
interface DataType {
  id: number;
  page: string;
