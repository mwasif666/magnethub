          ...
          <div className="container">
            <div className="col-12 text-center mb-60">
              ...
              <p className="tg-section-su-para">
                ...
                wide range of benefits for investors looking to grow their
                portfolios and find the next big opportunity. Here are just a
                few reasons why Magnate Hub is great for investors.
              </p>
            </div>
            ...
            {process_data.map((item, i) => (
              ...
              >
                ...
                {/* Image */}
                <div
                  className={`col-lg-6 col-md-12 d-flex ${
                    i % 2 !== 0 ? "order-lg-1" : ""
                  }`}
                >
                  <div className="w-100">
