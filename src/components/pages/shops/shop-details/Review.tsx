        ...
        <div className="col-xl-9">
          <div className="tg-product-details-inner">
            <div className="tg-tour-about-review-wrap mb-45">
              ...
              <p className="lh-28 mb-20">
                Castle in one day is next to impossible. Designed specifically
                for trave arelimited time in London, this tour ws you to check
                off a range of southern England‘s are historical
              </p>
            </div>
                    ...
                    <div>
                      <div className="tg-tour-about-cus-name mb-5 d-flex align-items-center justify-content-between flex-wrap">
                        <h6 className="mr-10 mb-10 d-inline-block">
                          Ronald Richards <span>- 20 Mar, 2023 . 4:00 Pm</span>
                        </h6>
                      ...
                      <p className="lh-28 mb-10">
                        Castle in one day is next to impossible. Designed
                        specifically for trave areli areafol time in London,
                        this tour allou to check off a range of southern day is
                        next together impossible. Designed speciEngland.
                      </p>
                      <a className="tg-tour-about-cus-reply" href="#">
                        Reply
                      </a>
                    </div>
                  </div>
                ...
                <li>
                  <div className="tg-tour-about-cus-review d-flex mb-40">
                    ...
                    <div>
                      <div className="tg-tour-about-cus-name mb-5 d-flex align-items-center justify-content-between flex-wrap">
                        <h6 className="mr-10 mb-10 d-inline-block">
                          Annette Black <span>- 20 Mar, 2023 . 4:00 Pm</span>
                        </h6>
                        <span className="tg-tour-about-cus-review-star mb-10 d-inline-block">
                          <i className="fa-sharp fa-solid fa-star"></i>
                          <i className="fa-sharp fa-solid fa-star"></i>
