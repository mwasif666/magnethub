                  ...
                  >
                    <div className="tg-shop-product-item mb-25">
                        ...
                        <div className="tg-shop-product-btn">
                          ...
                          <div className="tg-shop-product-hidden-btn">
                            ...
                            <a href="#">
                              ...
                              >
                                <path
                                  d="M10.222 1H14.1109M14.1109 1V4.88889M14.1109 1L0.888672 14.2222M14.1109 11.1111V15M14.1109 15H10.222M14.1109 15L9.44423 10.3333M0.888672 1.77778L4.77756 5.66667"
                                  stroke="currentColor"
                                  strokeWidth="1.4"
                                  strokeLinecap="round"
                                  strokeLinejoin="round"
                      ...
                      <div className="tg-shop-product-content">
                        <h3 className="tg-shop-product-title">
                          <Link href={`/shop-details/${item.id}`}>
                            {item.title}
                          </Link>
                        </h3>
