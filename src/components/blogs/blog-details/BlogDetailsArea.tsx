...
import styles from "./BlogDetailsArea.module.css";
...
const BlogDetailsArea = ({ id, url }: BlogDetailsProps) => {
  ...
  const [blogDetailData, setBlogDetailData] = useState<BlogDetail>({});
              ...
              <div className={styles.detailsWrapper}>
                ...
                <article className={styles.detailsCard}>
                  ...
                  <div className={styles.contentWrapper}>
                    ...
                    {/* {blogDetailData.name && (
                      <h2 className={styles.title}>{blogDetailData.name}</h2>
                    )} */}
                  ...
                  {isAuthenticated ? (
                    blogId !== null ? (
                      ...
                      <div className={styles.loginPrompt}>
                        Blog ID not found. Please refresh the page.
                      </div>
                    )
                  ) : (
                    <div className={styles.loginPrompt}>
