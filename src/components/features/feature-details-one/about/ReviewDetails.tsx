          ...
          <div className="tg-tour-about-cus-review d-flex mb-40">
            ...
            <div>
              ...
              <p className="lh-28 mb-10">
                ...
                for trave areli areafol time in London, this tour allou to check
                off a range of southern day is next together impossible.
                Designed speciEngland.
              </p>
              <Link className="tg-tour-about-cus-reply" href="#">
                Reply
              </Link>
            </div>
          </div>
